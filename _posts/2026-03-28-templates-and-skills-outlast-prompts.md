...
![반복 작업에서 프롬프트보다 템플릿과 skill이 더 오래 간다는 점을 설명하는 대표 이미지](/assets/images/2026/03/templates-vs-skills.jpg)
...
이 글은 왜 반복 작업을 프롬프트 하나에만 기대면 불안정해지는지, 그리고 템플릿과 skill로 분리했을 때 무엇이 좋아지는지 실전 기준으로 정리한다.
